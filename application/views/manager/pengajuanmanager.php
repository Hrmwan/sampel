    ...
    <tbody>
        <?php foreach ($cuti as $key => $cutiItem) { ?>
            <tr>
                ...
                <td>
                    <img src="<?= base_url() ?>assets/img/<?= $cutiItem->bukti_surat ?>" alt="<?= $cutiItem->bukti_surat ?>" width="100">
                </td>
                <td>
                        <?php
...
<div class="modal fade" id="modalTambahCuti" tabindex="-1" aria-labelledby="modalTambahCutiLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form action="<?php echo site_url('cuti/buatcutimanager'); ?>" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="file" id="formFile" name="bukti_surat">
        </div>
